export const retreatConfig = {
  schedule: {
    day1: [
      ...
      { time: "15:00 - 16:30", title: "어르신 가정 방문 봉사 (6가정)" },
      { time: "16:30 - 18:00", title: "신앙 프로그램 (손바닥 기도)" },
      { time: "18:00 - 20:00", title: "저녁식사 (부대찌개)" },
      { time: "20:00 - 22:00", title: "저녁 집회 (찬양 · 말씀 · 기도 · 자유기도)" },
      { time: "22:00 - 23:00", title: "야식 및 취침" },
    ],
    day2: [
      { time: "08:00 - 10:00", title: "아침묵상 · 아침식사 (자율)" },
      { time: "10:00 - 12:00", title: "장로님 간증" },
      { time: "12:00 - 14:00", title: "점심식사" },
      { time: "14:00 - 16:00", title: "체육대회" },
      { time: "16:00 - 18:00", title: "팀별 나눔 (카페서 기도제목·질문 나눔)" },
      { time: "18:00 - 20:00", title: "저녁식사 (바비큐)" },
      { time: "20:00 - 22:00", title: "저녁 집회 (찬양 · 말씀 · 기도 · 자유기도)" },
      { time: "22:00 - 23:00", title: "야식 및 취침" },
    ],
    day3: [
      ...
      { time: "12:00 - 13:00", title: "점심식사 (교회에서 해결)" },
